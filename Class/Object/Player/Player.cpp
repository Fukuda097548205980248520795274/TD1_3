...
void Player::Operation(const char* keys, const char* preKeys)
{
	...
	// スペースキーで、ドアに入ることができる
	if (keys[DIK_SPACE] && !preKeys[DIK_SPACE] || stickLeftY_ < 0)
	{
		if (vel_.x == 0.0f && vel_.y == 0.0f)
		{
			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_1 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_1 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_1 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_1)
			{
				...
				Scene::selectStage_ = 1;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_2 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_2 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_2 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_2)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 2;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_3 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_3 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_3 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_3)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 3;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_4 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_4 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_4 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_4)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 4;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_5 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_5 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_5 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_5)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 5;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_6 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_6 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_6 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_6)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 6;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_7 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_7 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_7 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_7)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
				...
				Scene::isPutPreparation_ = true;
				Scene::selectStage_ = 7;
			}

			if (Map::map_[map_.leftTop.row][map_.leftTop.column] == TILE_DOOR_8 ||
				Map::map_[map_.rightTop.row][map_.rightTop.column] == TILE_DOOR_8 ||
				Map::map_[map_.leftBottom.row][map_.leftBottom.column] == TILE_DOOR_8 ||
				Map::map_[map_.rightBottom.row][map_.rightBottom.column] == TILE_DOOR_8)
			{
				switch (Scene::areaNo_)
				{
				case AREA_STAR_LAND:
